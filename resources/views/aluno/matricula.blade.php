@extends('template.main', ['menu' => "admin", 'submenu' => "Alunos",  'rota'=>"index"])
...
<form action="{{ route('aluno.matriculaStore') }}" method="POST" enctype="multipart/form-data">
    @csrf  

    <div class="row">
        <div class="col">
            <table class="table align-middle caption-top table-striped">
                <caption><b>{{$aluno->nome}} ({{$curso->sigla}})</b></caption>
                ...
                <tbody>
                    @foreach ($disciplinas as $disciplina)
                        <tr>
                            ...
                            <td><input type="checkbox" name="disciplina_id[]" value="{{$disciplina->id}}"></td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
