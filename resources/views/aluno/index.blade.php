@extends('template.main', ['menu' => "admin", 'submenu' => "Alunos",  'rota'=>"aluno.create"])
            ...
            <tbody>
                @foreach ($data as $item)
                    <tr>
                        ...
                        <td>
                            <a href= "{{ route('aluno.edit', $item->id) }}" class="btn btn-success">
                            ...
                            <a href= "{{ route('aluno.matricula', $item->id) }}" style="cursor:pointer"  class="btn btn-warning">
