@extends('template.main', ['menu' => "admin", 'submenu' => "Editar Professor"])

@section('titulo') Desenvolvimento Web @endsection

@section('conteudo')

<form action="{{ route('professor.update', $id)}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col" >
            <div class="input-group mb-3">
                ...
                <select class="form-control @if($errors->has('eixo')) is-invalid @endif" name="eixo">
    ...
    <div class="row">
        <div class="col">
            <a href="{{route('professor.index')}}" class="btn btn-secondary btn-block align-content-center">
